...
export class CreateChildPartCategoryDto {
    @ApiProperty()
    @IsString()
    @IsNotEmpty()
...
export class CreateChildPartSubCategoryDto {
    @ApiProperty()
    @IsString()
    @IsNotEmpty()
    @Transform(({ value }) => value?.trim())
...
export class FilterPaginationChildPartCategoryDto extends PaginationRequestDto {
